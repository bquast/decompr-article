...
Hence, we provide examples of how decompr can create panel data using repeated analysis.

\Cref{sec:data} introduces the data as it is used by the package as well as two example data sets,
